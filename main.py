...
def main():
    ...
    comparer.semantic_accuracy(zs_icl)
    comparer.semantic_accuracy(zs_cot)
    comparer.semantic_accuracy(zs_base_4o_mini)
    comparer.semantic_accuracy(zs_base_3_5_turbo)
    comparer.semantic_accuracy(pe)
    comparer.semantic_accuracy(pe_4o_mini)
    comparer.semantic_accuracy(icl_4o_mini)
    comparer.semantic_accuracy(cot_4o_mini)
    comparer.semantic_accuracy(cot_3_5_turbo)
    comparer.semantic_accuracy(cbl_4o_mini_33)
    comparer.semantic_accuracy(cbl_4o_mini_32)
